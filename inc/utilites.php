...
// $attrs = get_post_meta( $_GET['post'], '_product_attributes', true );
// var_dump($attrs);

// var_dump( ExchangeUtils::updateWooAtt('newtest', 'newlabel3') );
// var_dump( ExchangeUtils::get_item_map_id( 'ЗИМНИЕ ШИПУЕМЫЕ' ) );
// var_dump( wc_get_attribute_taxonomies() );

// echo "<pre>";

// $datas = get_post_meta( $_GET['post'], '_product_attributes', true );
// foreach ($datas as $key => $data) {
//     var_dump($key);
//     // var_dump( wp_get_post_terms( $_GET['post'], $key ) );
// }
